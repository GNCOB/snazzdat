...
class PartnersControllerTest < ActionController::TestCase
  ...
  test "should create partner" do
    assert_difference('Partner.count') do
      post :create, partner: {address: @partner.address, email: @partner.email, name: @partner.name, phone: @partner.phone}
    end
  ...
  test "should update partner" do
    patch :update, id: @partner, partner: {address: @partner.address, email: @partner.email, name: @partner.name, phone: @partner.phone}
    assert_redirected_to partner_path(assigns(:partner))
  end
