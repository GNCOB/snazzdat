module ItemTypeConstants
  ...
  MEN_SHOE_SIZES = %w(8 8.5 9 9.5 10 10.5 11 11.5 12 13 14 15 16)
  MEN_SHOE_SIZES_STR = MEN_SHOE_SIZES.map{|s|"#{s}M"}

  WOMEN_SHOE_SIZES =  %w(5.5 6 6.5 7 7.5 8 8.5 9 9.5 10 10.5 11 11.5 12)
  WOMEN_SHOE_SIZES_STR = WOMEN_SHOE_SIZES.map{|s|"#{s}F"}
